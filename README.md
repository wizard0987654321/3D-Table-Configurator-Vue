...
```
cd existing_repo
git remote add origin https://git.thm.de/gsbs28/webframeworksvue.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.thm.de/gsbs28/webframeworksvue/-/settings/integrations)
